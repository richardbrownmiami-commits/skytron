...
const nav = `<div class="nav" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;justify-content:center">${page>1?`<a href="?${q}&p=1">\u00AB\u00AB</a><a href="?${q}&p=${page-1}">\u00AB</a>`:`<span style="color:#30363d">\u00AB\u00AB</span><span style="color:#30363d">\u00AB</span>`}<span style="color:#8b949e">Page</span><form style="display:inline;margin:0" method="GET" action=""><input type="hidden" name="c" value="${convId.replace(/"/g,'&quot;')}"/><input type="number" name="p" value="${page}" min="1" max="${totalPages}" style="width:55px;padding:4px 6px;border-radius:6px;border:1px solid #30363d;background:#0b1120;color:#e6edf3;font-size:0.85rem;text-align:center;outline:none"/><button type="submit" style="padding:4px 10px;border-radius:6px;border:1px solid #30363d;background:#161b22;color:#58a6ff;cursor:pointer;font-size:0.85rem;margin-left:4px">Go</button></form><span style="color:#8b949e">of ${totalPages} (${total} msgs)</span>${page<totalPages?`<a href="?${q}&p=${page+1}">\u00BB</a><a href="?${q}&p=${totalPages}">\u00BB\u00BB</a>`:`<span style="color:#30363d">\u00BB</span><span style="color:#30363d">\u00BB\u00BB</span>`}</div>`;
    ...
    return new Response(`<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Brain Chat</title><style>*{margin:0;padding:0;box-sizing:border-box}body{background:#0b1120;color:#e6edf3;font-family:system-ui;min-height:100vh}.layout{display:flex;gap:16px;max-width:1160px;margin:0 auto;padding:1.5rem;align-items:flex-start;min-height:100vh}.content{flex:1;min-width:0}.sidebar{position:sticky;top:1.5rem;width:165px;flex-shrink:0;background:rgba(15,23,42,.65);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(99,102,241,.15);border-radius:14px;padding:10px;display:flex;flex-direction:column;gap:2px;max-height:calc(100vh - 3rem);overflow-y:auto;align-self:flex-start}.sidebar .s-hdr{font-size:.6rem;text-transform:uppercase;letter-spacing:.06em;color:#64748b;padding:4px 8px 6px;font-weight:600}.sidebar a{display:flex;align-items:center;gap:6px;padding:4px 8px;border-radius:7px;font-size:.7rem;color:#64748b;text-decoration:none;transition:all .2s;border:1px solid transparent;white-space:nowrap}.sidebar a:hover{color:#e2e8f0;background:rgba(15,23,42,.65);border-color:rgba(99,102,241,.15)}.sidebar a.active{color:#6366f1;background:rgba(99,102,241,.1);border-color:rgba(99,102,241,.25)}.sidebar .ico{font-size:.85rem;width:18px;text-align:center;flex-shrink:0}h1{color:#58a6ff;font-size:1.5rem;margin-bottom:1rem}.control{margin-bottom:1rem}select{background:#161b22;color:#e6edf3;border:1px solid #30363d;border-radius:6px;padding:0.5rem;width:100%;font-size:1rem}.msgs{flex:1;overflow-y:auto}.msg{padding:1rem 1.2rem;margin-bottom:0.6rem;border-radius:10px;font-size:1rem;line-height:1.6}.msg.user{background:#1e3a5f;margin-left:1rem}.msg.assistant{background:#161b22;border:1px solid #30363d;margin-right:1rem}.meta{display:flex;justify-content:space-between;margin-bottom:0.4rem}.label{font-weight:600;font-size:0.85rem}.user .label{color:#60a5fa}.assistant .label{color:#94a3b8}.tool-error{background:#1a0a0a!important;border-left:3px solid #ef4444!important}
...
.tick-outcome.pending{color:#8b949e}.time{color:#6b7280;font-size:0.8rem}.text{word-break:break-word;white-space:pre-wrap}.nav{display:flex;justify-content:space-between;align-items:center;padding:0.8rem 0;color:#8b949e;font-size:0.9rem}.nav a{color:#58a6ff;text-decoration:none;padding:0.4rem 0.8rem;border:1px solid #30363d;border-radius:8px}.nav a:hover{background:#1f2937}.empty{text-align:center;padding:2rem;color:#6b7280}.input-row{display:flex;gap:0.5rem;padding:1rem 0;border-top:1px solid #30363d;margin-top:auto}input{flex:1;padding:0.8rem 1rem;border-radius:8px;border:1px solid #30363d;background:#0b1120;color:#e6edf3;font-size:1rem;outline:none}input:focus{border-color:#58a6ff}button{padding:0.8rem 1.2rem;border-radius:8px;border:none;background:#58a6ff;color:#0b1120;font-weight:bold;font-size:1rem;cursor:pointer}button:disabled{opacity:0.5}</style></head><body><div class="layout"><aside class="sidebar"><div class="s-hdr">Navigation</div><a href="/"><span class="ico">🏠</span>Home</a><a href="/astral"><span class="ico">✨</span>Astral</a><a href="/skytronchat" class="active"><span class="ico">💬</span>Chat</a><a href="/status"><span class="ico">📊</span>Status</a><a href="/brain/history"><span class="ico">📜</span>History</a><a href="/brain/memory"><span class="ico">🧠</span>Memory</a><a href="/brain/memory/search"><span class="ico">🔍</span>Search</a><a href="/brain/knowledge"><span class="ico">📚</span>Knowledge</a><a href="/brain/introspect"><span class="ico">💡</span>Insights</a><a href="/brain/settings"><span class="ico">🤖</span>Provider</a><a href="/cron/settings"><span class="ico">⏰</span>Cron</a><a href="/brain/prompt"><span class="ico">📝</span>Prompt</a><a href="/brain/repair"><span class="ico">🔧</span>Repair</a><a href="/brain/logs"><span class="ico">📋</span>Logs</a><a href="/brain/agents"><span class="ico">👤</span>Agents</a><a href="/brain/vectorize"><span class="ico">🔢</span>Vector</a><a href="/brain/source"><span class="ico">📄</span>Source</a><a href="/brain/scratchpad"><span class="ico">📓</span>Scratchpad</a><a href="/brain/journal"><span class="ico">📔</span>Journal</a></aside><main class="content"><h1>Chat with Skytron</h1><div class="control"><select id="convSelect" onchange="if(this.value)window.location='?c='+encodeURIComponent(this.value)"><option value="">-- Select conversation --</option>${sel}</select></div><div class="msgs">${msgs.length?msgs:`<div class="empty">No messages yet. Start a conversation via /skytronchat or POST /think</div>`}</div>${nav}<div class="input-row"><input type="text" id="msgInput" placeholder="Type your message..." /><button id="sendBtn" onclick="send()">Send</button></div></main></div>
<script>
